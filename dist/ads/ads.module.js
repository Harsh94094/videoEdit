...
exports.AdsModule = AdsModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: ad_entity_1.Ad.name, schema: ad_entity_1.AdSchema }])],
        controllers: [ads_controller_1.AdsController],
        providers: [ads_service_1.AdService],
        exports: [ads_service_1.AdService, mongoose_1.MongooseModule],
    })
], AdsModule);

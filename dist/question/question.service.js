...
let QuestionService = class QuestionService {
    ...
    async addQuestion(data) {
        ...
        if (data.type === 'TRUE_FALSE' && data.correctAnswer !== 'true' && data.correctAnswer !== 'false') {
            throw new common_1.BadRequestException('True/False questions must have "true" or "false" as the correct answer.');
        }
...
exports.QuestionService = QuestionService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(question_entity_1.Question.name)),
